...
```
    ...
    ## 1 10526424 2026-07-12 "2026-07-12\nDell Urich\n10.2"              67               10.2            85          77
...
```
    ...
    ## 1 10526424 2026-07-12 "2026-07-12\nDell Urich\n10.2"              67       6   33.3            2     5   38.5           1         100             4          33.3
...
```
    ...
    ## 1 Dell Urich 2026-07-12 white     1     4     5      1 tee     D               270          215 yes       on_target      tee      
    ## 2 Dell Urich 2026-07-12 white     1     4     5      2 fairway PW              137          144 no        left           full     
    ## 3 Dell Urich 2026-07-12 white     1     4     5      3 rough   PW               15            7 yes       on_target      chip     
    ## 4 Dell Urich 2026-07-12 white     2     3     3      1 tee     7               172          169 no        left           tee      
    ## 5 Dell Urich 2026-07-12 white     2     3     3      2 rough   PW                7            7 yes       on_target      chip     
    ## 6 Dell Urich 2026-07-12 white     3     5     5      1 tee     D               270          257 no        right          tee
...
#### LMER Model Summary
    ...
    ## -1.62182 -0.80346 -0.06136  0.63550  1.99453 
    ## 
    ## Random effects:
    ##  Groups   Name             Variance Std.Dev. Corr  
    ##  course   (Intercept)      13.455   3.6681         
    ##           `Handicap Index`  0.804   0.8967   -1.00 
    ##  Residual                  13.740   3.7068         
    ## Number of obs: 54, groups:  course, 7
    ## 
    ## Fixed effects:
    ##                                 Estimate Std. Error t value
    ## (Intercept)                    92.143278   2.216700  41.568
    ## `Handicap Index`                1.507386   0.799768   1.885
    ## course_rating                   0.947956   0.762149   1.244
    ## days                           -0.017761   0.005556  -3.197
    ## `Handicap Index`:course_rating -1.778314   0.465791  -3.818
    ## 
    ## Correlation of Fixed Effects:
    ##             (Intr) `HInd` crs_rt days  
    ## `HndcpIndx` -0.077                     
    ## course_rtng  0.281 -0.291              
    ## days        -0.633 -0.515 -0.137       
    ## `HIndx`:cr_ -0.182  0.224 -0.501  0.000
...
- This makes sense because `Gross Score` is used to directly determine
  ...
  - The effect is significant (**`t value` = 1.88**; significance :
    abs(**t value**) \> 1)
...
`Gross Score` increases by **0.95** strokes (it decreases).
...
- But this effect is strongly significant (**t value =** **-3.2**) and
...
`Handicap Index` on my expected `Gross Score` is **1.78** strokes less
...
(`Handicap Index`), by ~ **+/- 3.67** strokes. This value is the
...
`Gross Score`, overall: **3.71**. This is the `Random effects`
