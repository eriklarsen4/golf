...
```{r Update the club metrics table out, include = T, message = F, warning = F, eval = T, echo = F}
con <- golf::get_db_connection()
...
```{r Update the club metrics table in, include = T, message = F, warning = F, echo = F, eval = T}
con <- golf::get_db_connection()
