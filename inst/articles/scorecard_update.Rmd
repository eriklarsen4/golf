...
```{r Update the players table in, include = T, message = F, warning = F, echo = F, eval = T}
con <- golf::get_db_connection()
...
```{r Update the courses table in, include = T, message = F, warning = F, eval = T, echo = F}
con <- golf::get_db_connection()
...
```{r Update the rounds table in, include = T, message = F, warning = F, eval = T, echo = F}
con <- golf::get_db_connection()
...
```{r Update the club metrics table in, include = T, message = F, warning = F, eval = T, echo = F}
con <- golf::get_db_connection()
...
```{r Validate dev updates, include = T, eval = T, message = F, warning = F, echo = F}
con <- golf::get_db_connection(db_path = real_db)
golf::validate_dev_tables(db_path = real_db)
```

```{r Promote dev to prod, include = T, eval = T, message = F, warning = F, echo = F}
con <- golf::get_db_connection(db_path = real_db)
golf::promote_dev_to_production(db_path = real_db)
```

```{r Pass Data Through Skill Pipeline, include = T, eval = T, message = F, warning = F, echo = F}
con <- golf::get_db_connection(db_path = real_db)
golf::run_skill_pipeline(db_path = real_db)
```

```{r Overwrite PowerBI CSVs, include = T, eval = F, message = F, warning = F, echo = F}
